      ...
      {isCompact
        ? (
          <Stack direction="row" justifyContent="space-between" alignItems="center" padding={1}>
            ...
            <Typography variant="h1" fontSize="min(8vw, 8vh)" noWrap textAlign="center">Welcome!</Typography>

            <Box />
          </Stack>
        )
        : <Typography variant="h1" fontSize="min(12vw, 12vh)" noWrap textAlign="center">Welcome to StudentScroll!</Typography>
      }
