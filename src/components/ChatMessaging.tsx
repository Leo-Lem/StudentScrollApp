...
import { Box, Stack, List, Typography, ListItem, TextField, Button, ListItemText } from "@mui/material";
  ...
  return (
    ...
    <Stack spacing={2} marginTop={3}>
      ...
      <List className="inputContainer">
        ...
        />
        <Button variant="contained" color="primary" onClick={(event: React.FormEvent<HTMLButtonElement>) => {
          event.preventDefault();
          postMessage(message).catch((err) => {console.log(err)});
          setMessage("");
        }}>          
          Send
        </Button>
